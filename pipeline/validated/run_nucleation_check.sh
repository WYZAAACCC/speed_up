...
prob = """  # =====================================================================
  ...
  #   | γ    | **0.124** J/m² | **由 JOM 2018 的 Γ=1.88e-7 K·m 反推**（γ=Γ·ΔS_f,v） | **L+T** |
  ...
  [nuc_probability]
    ...
    #   gamma : 0.2      → **0.124**  （L+T 档：JOM 2018 的 Γ=1.88e-7 K·m 反推
    #                                  γ_SL = Γ·ΔS_f,v = 1.88e-7×6.59e5 = 0.124 J/m²）
    #                                  ⚠ γ³ 进前置因子 ⇒ 0.2/0.124 差 1.6 倍 ⇒ 形核率差 ~4 倍
    #   mL    : 600      → **819**    （T 档：van't Hoff  m_L = −R·T_m²(1−k)/ΔH_f
    #                                  = −8.314×1941²×0.3697/14150 = −819 K/摩尔分数）
    #                                  ⚠ JOM 2018 给的 −0.088 K/% 与 Ti64 相图不符（差 30 倍以上），
    #                                    不能用；见 §1.2
    constant_expressions = '1923 1.28e9 0.124 1.380649e-23 0.002673 1.0e6 0.036 0.6303 819'
